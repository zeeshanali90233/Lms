...
const TransPagination = ({ data ,isSuperAdmin,isAdmin,isStaff,isTeacher,isStudent}) => {
    ...
    <Table sx={{ minWidth: 700 }} aria-label="customized table">
      ...
      <TableBody>
        ...
        {(rowsPerPage > 0
         ...
         return(
            (search.length===0 || row.id.includes(search) || row.to.toLowerCase().includes(search.toLowerCase()) || row.from.toLowerCase().includes(search.toLowerCase()))? 
