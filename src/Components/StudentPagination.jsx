...
const StudentPagination = ({ data ,isSuperAdmin,isStaff,isAdmin}) => {
  const search = useContext((isSuperAdmin)?searchKeyword:(isAdmin)?searchKeywordAdmin:(isStaff)?searchKeywordStaff:"");
