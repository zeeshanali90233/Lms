...
export const searchKeywordStaff = createContext("");
export const staffUser = createContext("");
...
const StaffDashboard = () => {
  ...
  useEffect(() => {
    ...
    const getUser = async () => {
      ...
      const userFirebaseId = localStorage.getItem("staffUser");
      if (userFirebaseId) {
        db.collection("staff")
          .doc(userFirebaseId)
          .onSnapshot((snapshot) => {
  ...
  return (
    ...
    <div className="admin-dashboard ">
            ...
            <li class="nav-item dropdown px-lg-5 px-sm-2 ms-1">
              ...
              >
                <Avatar
                  alt="User"
                  src={
                    user && user.staffphoto ? user.staffphoto.URL : emptyProfile
                  }
              ...
              >
                ...
                <MenuItem onClick={handleClose} className="text-uppercase">
                  {user && user.designation !== undefined
                    ? user.designation
                    : ""}
                </MenuItem>
                <MenuItem onClick={handleClose} className="text-uppercase">
                  {user && user.staffid !== undefined ? user.staffid : ""}
                </MenuItem>
      ...
      <div className="admin-sidebar position-absolute bg-dark ">
        ...
        <section className="w-100">
          ...
          <div className="options pt-2 ">
            ...
            {(user && user.studentauthority && user.studentauthority.add)?<NavLink className="text-decoration-none text-white" to="admission">
            ...
            {(user && user.studentauthority && user.studentauthority.review)?<NavLink className="text-decoration-none text-white" to="role">
           ...
           {(user && user.studentauthority && user.studentauthority.review)? <NavLink className="text-decoration-none text-white" to="students">
            ...
            {(user && user.courseauthority && user.courseauthority.review)?<NavLink className="text-decoration-none text-white" to="courses">
            ...
            {/* Fees */}
            {(user && user.feesauthority && user.feesauthority.review)?<NavLink className="text-decoration-none text-white" to="fees">
      ...
      <section className="main-content text-secondary ">
        {/* <AdminRouting/> */}
        <searchKeywordStaff.Provider value={search}>
          <staffUser.Provider value={user}>
            <Outlet />
          </staffUser.Provider>
        </searchKeywordStaff.Provider>
      </section>
    </div>
  );
};
