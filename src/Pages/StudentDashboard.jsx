...
export const searchKeywordStudent = createContext("");
...
const StudentDashboard = () => {
  ...
  return (
          ...
          <ul className="navbar-nav ">
            <li class="nav-item dropdown px-lg-5 px-sm-2 ms-1">
              ...
              >
                <Avatar
                  alt="User"
                  src={(user && user.studentphoto) ? user.studentphoto.URL : emptyProfile}
      ...
      <section className="main-content text-secondary ">
        {/* <AdminRouting/> */}
        <searchKeywordStudent.Provider value={search}>
          <studentUser.Provider value={user}>
            <Outlet />
          </studentUser.Provider>
        </searchKeywordStudent.Provider>
      </section>
    </div>
  )
}
