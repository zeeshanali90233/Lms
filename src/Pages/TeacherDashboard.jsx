...
export const searchKeywordTeacher = createContext("");
export const teacherUser = createContext("");
...
const TeacherDashboard = () => {
  ...
  useEffect(() => {
    ...
    const getUser = async () => {
      ...
      const userFirebaseId = localStorage.getItem("teacherUser");
      if(userFirebaseId){
  ...
  return (
    ...
    <div className="teacher-dashboard ">
          ...
          <ul className="navbar-nav ">
            <li class="nav-item dropdown px-lg-5 px-sm-2 ms-1">
              ...
              >
                <Avatar
                  alt="User"
                  src={(user && user.teacherphoto) ? user.teacherphoto.URL : emptyProfile}
              ...
              >
                ...
                <MenuItem onClick={handleClose} className="text-uppercase">
                  {user && user.tid!==undefined  ? user.tid: ""}
                </MenuItem> 
      ...
      <div className="admin-sidebar position-absolute bg-dark ">
        ...
        <section className="w-100">
          ...
          <div className="options pt-2 ">
            ...
            <NavLink className="text-decoration-none text-white" to="mysalary">
              <abbr title="Account" className="text-decoration-none">
                <div className="option option-1 d-flex w-100 ps-3 py-3">     
                  <div className="icon pe-2">
                    {" "}
                    <FaMoneyBillWave color="white" size={25} />
                  </div>
                  <div className="text text-white">Salary</div>
                </div>
              </abbr>
            </NavLink>
      ...
      <section className="main-content text-secondary ">
        {/* <AdminRouting/> */}
        <searchKeywordTeacher.Provider value={search}>
          <teacherUser.Provider value={user}>
            <Outlet />
          </teacherUser.Provider>
        </searchKeywordTeacher.Provider>
      </section>
    </div>
  );
};
